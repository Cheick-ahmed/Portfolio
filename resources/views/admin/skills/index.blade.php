...
@section('content')
    <div class="flex justify-between items-center mb-12">
        <h3 class="font-rubik text-3xl text-white font-medium">Skills ({{ count($skills)}})</h3>
                    ...
                    <tr class="border border-teal-500">
                        ...
                        <td class="px-5 py-5 border-b-4 border-teal-500 capitalize text-sm">
                            <div class="flex items-center">
                                <a href="{{ route('admin.skills.edit', $skill->slug) }}" class="mr-6">
                                ...
                                <form action="{{route('admin.skills.destroy', $skill)}}" method="post">
                                    @csrf()
                                    @method('DELETE')
                                    <button  type="button" onclick="confirm('{{ __("Are you sure you want to delete this skill ?") }}') ? this.parentElement.submit() : ''" class="outline-none block">
